...
export default function Product({product}) {
  return (
    <Link className="product" to={`/product/${product.documentId}`}>
      ...
      <h1 className="capitalize font-bold text-[20px] leading-[100%] tracking-normal mt-4">{product.name}</h1>
      ...
      <div className="pricing flex gap-2.5 mt-2 items-center">
        ...
        <div className="discount bg-[#FF33331A] py-1.5 px-3.5 rounded-full">
