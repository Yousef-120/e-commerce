...
export default function Hero() {
  return (
    <div className="w-full bg-[#F2F0F1] flex justify-center">
      <div className="container md:flex justify-between items-center text-[#000000]">
        <div className="hero-info">
          <h1 className="uppercase integral-font font-bold text-[38px] md:text-[64px] leading-11 md:leading-16 mt-10 md:mt-0">
